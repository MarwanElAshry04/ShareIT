...
namespace ShareIT.Seeds
{
    ...
    public static class DefaultData
    {
        public static async Task SeedAsync(ApplicationDbContext context)
        {
            ...
            // Ticket types are the TicketType enum now (the Category lookup was retired).
            ...
            {
                MakeTicket("SHR-2026-0001", TicketType.Issue,  "Reported inappropriate behavior from a colleague during a team meeting.",
                ...
                MakeTicket("SHR-2026-0002", TicketType.Issue,  "Fire exit on the 3rd floor is blocked by stored equipment.",
                    companies[1].Name, departments[6].Name, "In-Process", "Valid",   now.AddDays(-12), pwd,
                    Rep(null, null, null, "Anonymous", null, null)),

                MakeTicket("SHR-2026-0003", TicketType.Issue,  "Suspected irregularities in a recent supplier procurement process.",
                ...
                MakeTicket("SHR-2026-0004", TicketType.Issue,  "Concerns about unequal access to training opportunities.",
                ...
                MakeTicket("SHR-2026-0005", TicketType.Idea, "Introduce a shared digital request tracker to cut email back-and-forth.",
                    null, null, "Initiate",   null, now.AddDays(-5),  pwd,
                    Rep("Omar Hassan", "omar.hassan@elsewedy.com", "01009998887", "Disclosed", 2, "EE1120")),

                MakeTicket("SHR-2026-0006", TicketType.Idea, "Add a mobile app for field engineers to log work orders offline.",
                    null, null, "In-Process", null, now.AddDays(-9),  pwd,
                    Rep("Youssef Fathy", "youssef.fathy@elsewedy.com", "01555666777", "Disclosed", 3, "EE1150")),

                MakeTicket("SHR-2026-0007", TicketType.Idea, "Offer flexible start times to ease morning traffic congestion.",
                    null, null, "Closed",     null, now.AddMonths(-1), pwd,
                    Rep("Laila Mahmoud", "laila.mahmoud@elsewedy.com", "01778889990", "Disclosed", 0, "EE1188")),

                MakeTicket("SHR-2026-0008", TicketType.Feedback,   "The new onboarding program was clear and very helpful. Thank you!",
                    null, null, "Closed",     null, now.AddDays(-2),  pwd,
                    Rep("Ahmed Zaki", "ahmed.zaki@elsewedy.com", "01004445556", "Disclosed", 2, "EE1201")),

                MakeTicket("SHR-2026-0009", TicketType.Feedback,   "Cafeteria menu variety has improved a lot this quarter.",
                    null, null, "Initiate",   null, now.AddDays(-1),  pwd,
                    Rep(null, null, null, "Anonymous", null, null)),

                MakeTicket("SHR-2026-0010", TicketType.Issue,  "Slippery floor near the warehouse loading bay after rain.",
                ...
                MakeTicket("SHR-2026-0011", TicketType.Feedback,   "IT support response time has been excellent lately.",
                    null, null, "Closed",     null, now.AddMonths(-3), pwd,
                    Rep("Nour Ibrahim", "nour.ibrahim@elsewedy.com", "01008887776", "Disclosed", 2, "EE1260")),

                MakeTicket("SHR-2026-0012", TicketType.Issue,  "Repeated dismissive comments from a supervisor toward the team.",
        ...
        private static Ticket MakeTicket(
            string refNo, TicketType kind, string desc,
