        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    logStat = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OutlookItemId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TempEmails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reporters_Departments_DepratmentId",
                        column: x => x.DepratmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reporters_Relations_RelationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcerningCompany = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcerningDepartment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcerningOther = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcerningPerson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    toMails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ccMails = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_Tickets_compId",
                        column: x => x.compId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    compId = table.Column<int>(type: "int", nullable: false),
                    blobDESC = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recordings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Recordings_Tickets_compId",
                        column: x => x.compId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_compId",
                table: "Attachments",
                column: "compId");

            migrationBuilder.CreateIndex(
                name: "IX_Chats_compId",
                table: "Chats",
                column: "compId");

            migrationBuilder.CreateIndex(
                name: "IX_Recordings_compId",
                table: "Recordings",
                column: "compId");

            migrationBuilder.CreateIndex(
                name: "IX_Reporters_DepratmentId",
                table: "Reporters",
                column: "DepratmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Reporters_RelationId",
                table: "Reporters",
                column: "RelationId");
